...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="float:left">
        <asp:DataList ID="DataList2" runat="server" DataKeyField="categoryid" DataSourceID="SqlDataSource4">
            <ItemTemplate>
                <div style="width: 745px;height: 40px;padding: 0 9px;border-bottom: 1px solid #ccc;"><asp:Label ID="categorynameLabel" runat="server" Text='<%# Eval("categoryname") %>' Font-Bold="True" Font-Size="Larger" /></div>
            </ItemTemplate>
        </asp:DataList>
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:lbConnectionString12 %>" SelectCommand="SELECT * FROM [category] WHERE ([categoryid] = @categoryid)">
            <SelectParameters>
    ...
    width: 410px;"></asp:HyperLink>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:lbConnectionString11 %>" SelectCommand="SELECT * FROM [lbnr] WHERE ([categoryid] = @categoryid)">
            <SelectParameters>
                <asp:QueryStringParameter Name="categoryid" QueryStringField="categoryid" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>

        <asp:HyperLink ID="HyperLink3" runat="server" Font-Size="12px" NavigateUrl="~/index_Gengduo.aspx"> 更多>> </asp:HyperLink>
    </div>
